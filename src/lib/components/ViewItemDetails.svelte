...
<div class="owner">
    ...
    {#if item.action == false}
        <svg xmlns="http://www.w3.org/2000/svg" height="3.75rem" viewBox="0 -960 960 960" width="3.75rem" fill="rgb(0 0 0 / var(--tw-text-opacity, 1))">
